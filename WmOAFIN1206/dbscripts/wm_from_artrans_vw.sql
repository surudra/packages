...
ORG_ORGANIZATION_DEFINITIONS ORG,  
WM_RA_ADDRESSES_ALL_VW RADD,  
WM_RA_SITE_USES_ALL_VW SITE ,  
AR_LOOKUPS AL,  
...
ATTRIBUTE7, ATTRIBUTE8, ATTRIBUTE9, ATTRIBUTE10, 
ATTRIBUTE11, ATTRIBUTE12, ATTRIBUTE13, ATTRIBUTE14, 
ATTRIBUTE15, REVENUE_SALESGROUP_NAME, NON_REVENUE_SALESGROUP_NAME ) AS SELECT  
...
(select group_name from jtf_rs_groups_tl where group_id=SCREDITS.REVENUE_SALESGROUP_ID) REVENUE_SALESGROUP_NAME, 
(select group_name from jtf_rs_groups_tl where group_id=SCREDITS.NON_REVENUE_SALESGROUP_ID) NON_REVENUE_SALESGROUP_NAME 
FROM  
