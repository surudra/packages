/*  ***************************************************************************
    ...
    * Process Name:         Uninstall objects for GL Journal inbound
    * Program Name:         wm_drop_into_journal.sql
    * Version #:            1.0
    * Title:                Uninstall objects used for GL Journal Inbound Transactions    
    * Utility:              SQL*Plus
    * Created by:           
    * Creation   Date:      
    *
    * Description:          Uninstall objects used for GL Journal Inbound Transactions    			
    *
    *           
    * Tables usage:     
    *           
...
*/
  ...
  prompt Program : wm_drop_into_journal.sql
...
DROP PACKAGE WM_JOURNAL_IMP_HANDLER_PKG
/
clear buffer

SHOW ERRORS

prompt UnInstall Complete for GL Journal Inbound
