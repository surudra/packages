...
ATE, FROM_TYPE_LOOKUP_CODE, END_DATE, AUTHORIZATION_STATUS, 
EVISED_DATE, NOTE_TO_AUTHORIZER, NOTE_TO_VENDOR, PRINT_COUNT, 
...
EQUEST_ID, USSGL_TRANSACTION_CODE, CLOSED_DATE, FIRM_DATE, 
