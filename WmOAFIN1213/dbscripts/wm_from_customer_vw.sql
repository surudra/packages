...
ARRIVALSETS_INCLUDE_LINES_FLAG, SCHED_DATE_PUSH_FLAG, INVOICE_QUANTITY_RULE, PRICING_EVENT
  ...
  SU.PRICING_EVENT 
FROM  
  WM_RA_SITE_USES_ALL_VW SU, 
  WM_RA_SITE_USES_ALL_VW SU_BILL, 
  AR_LOOKUPS L_SU, 
  RA_TERMS TERM, 
  AR_LOOKUPS L_FOB, 
  WM_RA_CONTACTS_VW CONT, 
