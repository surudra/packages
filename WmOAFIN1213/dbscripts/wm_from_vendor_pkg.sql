...
CREATE OR REPLACE PACKAGE WM_VENDOR_FETCH_PKG AUTHID CURRENT_USER AS

PROCEDURE wm_fetch_vendors(record_count OUT NUMBER);

END WM_VENDOR_FETCH_PKG;
/

CREATE OR REPLACE PACKAGE BODY WM_VENDOR_FETCH_PKG AS
 
PROCEDURE wm_fetch_vendors(record_count OUT NUMBER) IS
