/*  ***************************************************************************
    ...
    * Process Name:         Installation Script for Bank Statement Import and Reconciliation
    * Program Name:         wm_install_into_bankstmt.sql
    * Version #:            1.0
    * Title:                Installation Script for Bank Statement Import and Reconciliation
    * Utility:              SQL*Plus
    * Created by:           
    * Creation   Date:      
    *
    * Description:         This script calls all other scripts used for installing Components
    *				   for Bank Statement Import and Reconciliation Transactions.      
    *
    *           
    * Tables usage:     
    *           
...
prompt Install Completed for Bank Statement Import and Reconciliation
