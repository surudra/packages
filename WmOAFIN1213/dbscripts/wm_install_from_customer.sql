/*  ***************************************************************************
    ...
    * Process Name:         Installation Script for Customer Outbound
    * Program Name:         wm_install_from_customer.sql
    * Version #:            1.0
    * Title:                Installation Script for Customer Outbound
    * Utility:              SQL*Plus
    * Created by:           
    * Creation   Date:      
    *
    * Description:         This script calls all other scripts used for installing compenents 
    *				   for Customer Outbound Trnsactions.      
    *
    *           
    * Tables usage:     
    *           
...
@@wm_from_customer_pkg.sql

SHOW ERRORS

prompt Install Completed for Customer Outbound
