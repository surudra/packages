...
ap_suppliers pv , 
ap_suppliers pv1 , 
AP_SUPPLIER_SITES_ALL pvs , PO_VENDOR_CONTACTS pvc , ap_terms at , ap_terms at1 , po_line_types plt ,
...
po_lines_all pl , 
ap_suppliers pv,
ap_suppliers pv1 ,  AP_SUPPLIER_SITES_ALL pvs , PO_VENDOR_CONTACTS pvc , 
...
pll.price_override
FROM 
ap_suppliers pv , AP_SUPPLIER_SITES_ALL pvs , PO_VENDOR_CONTACTS pvc , financials_system_params_all fsp , 
