/*  ***************************************************************************
    ...
    * Process Name:         Uninstall objects for PO inbound Receiving Transactions
    * Program Name:         wm_drop_into_rcv.sql
    * Version #:            1.0
    * Title:                Uninstall objects used for PO Inbound Receiving Transactions    
    * Utility:              SQL*Plus
    * Created by:           
    * Creation   Date:      
    *
    * Description:          Uninstall objects used for PO Inbound Receiving Transactions    			
    *
    *           
    * Tables usage:     
    *           
...
*/
  ...
  prompt Program : wm_drop_into_rcv.sql
...
DROP PACKAGE WM_RECEIVING_IMP_HANDLER_PKG
/

-- DROP SYNONYMS in APPS----------------------------------------------------

DROP SYNONYM WM_RCV_GROUP_S
/
...
prompt UnInstall Complete for PO Receiving Inbound
