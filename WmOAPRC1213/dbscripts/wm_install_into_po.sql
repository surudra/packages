/*  ***************************************************************************
    ...
    * Process Name:         Installation Script for PO Inbound
    * Program Name:         wm_install_into_po.sql
    * Version #:            1.0
    * Title:                Installation Script for PO Inbound
    * Utility:              SQL*Plus
    * Created by:           
    * Creation   Date:      
    *
    * Description:         This script calls all other scripts used for installing Components
    *				   for PO inbound Trnsactions.      
    *
    *           
    * Tables usage:     
    *           
...
prompt Install Completed for PO Inbound
