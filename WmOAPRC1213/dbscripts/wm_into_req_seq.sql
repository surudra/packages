/*  ***************************************************************************
    ...
    * Creation   Date:      
    *
    * Description:          Creates sequence wm_req_dist_s
    * 			    Creates sequence wm_req_batch_s
    *			    
    *
    *           
    *
    ...
    * Date         | Name               | Remarks 
    *==========================================================================
    * 04-OCT-2002    Rajib Naha		   Created
    ***************************************************************************
*/
...
--      Create Sequences
/*----------------------------------------------------------------------*/
DROP SEQUENCE wm_req_dist_s
/

CREATE SEQUENCE wm_req_dist_s increment by 1 start with 1000 nomaxvalue nocycle cache 10 order
/

DROP SEQUENCE wm_req_batch_s
/
CREATE SEQUENCE wm_req_batch_s increment by 1 start with 1000 nomaxvalue nocycle cache 10 order
/

/*----------------------------------------------------------------------*/
--      Give grant all on custom data objects to APPS User
/*----------------------------------------------------------------------*/
grant all on wm_req_dist_s to &&apps_user with grant option
/
