/*  ***************************************************************************
    ...
    *				   for Purchase Order Trnsactions outbound.      
    *
    *           
    * Tables usage:     
    *           
...
prompt Installing objects for orderstatus outbound...
@@wm_install_from_orderstatus.sql

prompt Installing Views for Purchase Order Outbound...
@@wm_from_po_vw.sql

prompt Installing Packages for Purchase Order Outbound.....
@@wm_from_po_pkg.sql

SHOW ERRORS

prompt Install Completed for Purchase Order Outbound
