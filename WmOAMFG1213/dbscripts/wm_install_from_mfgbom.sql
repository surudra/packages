/*  ***************************************************************************
    ...
    * Process Name:         Installation Script for Manufacturing BOM Outbound
    * Program Name:         wm_install_from_mfgbom.sql
    * Version #:            1.0
    * Title:                Installation Script for Manufacturing BOM Outbound
    * Utility:              SQL*Plus
    * Created by:           
    * Creation   Date:      
    *
    * Description:         This script calls all other scripts used for installing compenents 
    *				   for Manufacturing BOM Outbound Transactions.      
    *
    *           
    * Tables usage:     
    *           
...
@@wm_from_mfgbom_vw.sql

prompt Installing Triggers.....
@@wm_from_mfgbom_trg.sql

prompt Installing Packages.....
@@wm_from_mfgbom_pkg.sql

SHOW ERRORS

prompt Install Completed for Manufacturing BOM Outbound
