/*  ***************************************************************************
    ...
    * Process Name:         Uninstall objects for Cycle Count Transaction inbound
    * Program Name:         wm_drop_into_cyclecount.sql
    * Version #:            1.0
    * Title:                Uninstall objects used for Cycle Count Transaction Inbound Transactions    
    * Utility:              SQL*Plus
    * Created by:           
    * Creation   Date:      
    *
    * Description:          Uninstall objects used for Cycle Count Transaction Inbound Transactions    			
    *
    *           
    * Tables usage:     
    *           
...
*/
  ...
  prompt Program : wm_drop_into_cyclecount.sql
...
DROP PACKAGE Wm_Inv_CC_Imp_Handler_Pkg
/
...
prompt UnInstall Complete for Cycle Count Transaction Inbound
