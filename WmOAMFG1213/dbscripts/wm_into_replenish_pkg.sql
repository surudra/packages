 /***************************************************************************
    ...
    * Program Name:         wm_open_replenish_Handler_Pkg.pkg
    * Version #:            1.0
    ...
    * Date       | Name                  | Remarks
    *==========================================================================
     09-OCT-02	 Panchali Samanta        Created
    ***************************************************************************
*/
  ...
  prompt Program : wm_open_replenish_Handler_Pkg.pkg
...
CREATE OR REPLACE PACKAGE wm_open_replenish_Handler_Pkg AUTHID CURRENT_USER AS
	...
	-- If validation is sucessful then invoke Replenishment Process
	  IF v_status = 'SUCCESS' THEN
		...
		IF v_Found = 'N' THEN
		  ...
		  -- Call to submit request
	        v_statement:='Submitting Concurrent Request for '||
					'Processing';
		  Wm_Conc_Request_Pkg.wm_request_submit(v_application_id,
							v_user_responsibility_id,
							v_user_id,
