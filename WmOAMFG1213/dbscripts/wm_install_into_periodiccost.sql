/*  ***************************************************************************
    ...
    * Process Name:         Installation Script for Periodic Cost Open Interface Inbound Transaction
    * Program Name:         wm_install_into_periodiccost.sql
    * Version #:            1.0
    * Title:                Installation Script for Periodic Cost Open Interface Inbound Transaction
    * Utility:              SQL*Plus
    * Created by:           
    * Creation   Date:      
    *
    * Description:         This script calls all other scripts used for installing Components
    *				   for Periodic Cost Open Interface Inbound Transaction 
    *
    *           
    * Tables usage:     
    *           
...
prompt Install Completed for Periodic Cost Open Interface Inbound Transaction
