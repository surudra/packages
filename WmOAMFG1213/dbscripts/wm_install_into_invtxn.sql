/*  ***************************************************************************
    ...
    * Process Name:         Installation Script for Inventory Transaction Inbound
    * Program Name:         wm_install_into_invtxn.sql
    * Version #:            1.0
    * Title:                Installation Script for Inventory Transaction
    * Utility:              SQL*Plus
    * Created by:           
    * Creation   Date:      
    *
    * Description:         This script calls all other scripts used for installing Components
    *				   for Inventory Transaction inbound Trnsactions.      
    *
    *           
    * Tables usage:     
    *           
...
prompt Install Completed for Inventory Transaction Inbound
