...
BOM.COMMON_ALT_BOM_DESIGNATOR COMMON_ALT_BOM_DESIGNATOR, -- -- Added for 10.7 SC
...
--AND MUM.LANGUAGE = USERENV('LANG') -- Removed for 10.7 SC
...
DECODE(BIC.INCLUDE_ON_BILL_DOCS,1,'Yes',2,'No',NULL) INCLUDE_ON_BILL_DOCS, 
...
MIR.REVISION REVISION,
-- BIC1.OPERATION_SEQ_NUM OLD_OPERATION_SEQ_NUM, -- Removed for 10.7 SC
-- BIC1.EFFECTIVITY_DATE OLD_EFFECTIVITY_DATE, -- Removed for 10.7 SC
...
AND FCL.APPLICATION_ID(+) = 401 
--AND NVL(BIC.ECO_FOR_PRODUCTION,2) = 2 -- Removed for 10.7 SC
/
