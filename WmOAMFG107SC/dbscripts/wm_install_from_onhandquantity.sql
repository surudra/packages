/*  ***************************************************************************
    ...
    * Process Name:         Installation Script for INV On-Hand Quantity Query
    * Program Name:         wm_install_from_onhandquantity.sql
    * Version #:            1.0
    * Title:                Installation Script for INV On-Hand Quantity Query
    * Utility:              SQL*Plus
    * Created by:           
    * Creation   Date:      
    *
    * Description:         This script calls all other scripts used for installing compenents 
    *			   for INV On-Hand Quantity Outbound Transactions.      
    *
    *           
    * Tables usage:     
    *           
...
prompt Install Completed for INV On-Hand Quantity Query
