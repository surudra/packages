/*  ***************************************************************************
    ...
    * Process Name:         Installation Script for Inventory Items Inbound
    * Program Name:         wm_install_into_invitem.sql
    * Version #:            1.0
    * Title:                Installation Script for Inventory Items Inbound
    * Utility:              SQL*Plus
    * Created by:           
    * Creation   Date:      
    *
    * Description:         This script calls all other scripts used for installing Components
    *				   for Inventory Items Transaction Inbound
    *
    *           
    * Tables usage:     
    *           
...
prompt Install Completed for Inventory Items Inbound transaction
