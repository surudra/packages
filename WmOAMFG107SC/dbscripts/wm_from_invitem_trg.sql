/*  ***************************************************************************
    ...
    *					MTL_SYSTEM_ITEMS, MTL_ITEM_CATEGORIES, MTL_ITEM_REVISIONS
    * Tables usage:     
    *           
    *
    * Procedures and Functions:
    *		
    * Trigger: WM_MTL_SYSTEM_ITEMS_IU_TRG 		-> To populate WM_TRACKCHANGES table on I/U
...
on MTL_SYSTEM_ITEMS table and gives a call to WEB_TRANSACTION procedure to populate  
WM_TRACKCHANGES tables.

******************************************************************************************/

CREATE OR REPLACE TRIGGER &&apps_user..wm_mtl_system_items_iu_trg
AFTER INSERT OR UPDATE ON MTL_SYSTEM_ITEMS
...
AFTER INSERT OR UPDATE ON MTL_ITEM_REVISIONS
REFERENCING NEW AS NEW OLD AS OLD FOR EACH ROW
DECLARE
p_rec_wm_trackChange wm_trackchanges%ROWTYPE;
v_transaction_type VARCHAR2(100):='ITEM';
