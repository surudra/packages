/*  ***************************************************************************
    ...
    * Program Name:         wm_drop_from_onhandquantity.sql
    * Version #:            1.0
    * Title:                Uninstall objects used for INV On-Hand Quantity Transactions    
    * Utility:              SQL*Plus
    * Created by:           
    * Creation   Date:      
    *
    * Description:          Uninstall objects used for INV On-Hand Quantity Transactions    			
    *
    *           
    * Tables usage:     
    *           
...
*/
  ...
  prompt Program : wm_drop_from_onhandquantity.sql
...
DROP VIEW WM_INV_ONHAND_QRY_VW 
/
clear buffer

SHOW ERRORS

prompt UnInstall Complete for INV On-Hand Quantity Query
