/*  ***************************************************************************
    ...
    * 
    *		
    * Triggers to enable: 	wm_mtl_system_items_iu_trg,wm_mtl_item_categories_iud_trg,wm_mtl_item_revisions_iu_trg
    *
...
*/
  ...
  prompt Program : wm_enable_from_ap_invoices.sql

  connect &&apps_user/&&appspwd@&&DB_Name

REM "Enabling Trigger For Ap Invoices....."

ALTER TRIGGER wm_mtl_system_items_iu_trg ENABLE;


ALTER TRIGGER wm_mtl_item_categories_iud_trg ENABLE;


ALTER TRIGGER wm_mtl_item_revisions_iu_trg ENABLE;
