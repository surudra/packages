/*  ***************************************************************************
    ...
    * Process Name:         Installation Script for Customer Item Cross References Inbound
    * Program Name:         wm_install_into_cicrossref.sql
    * Version #:            1.0
    * Title:                Installation Script for Customer Item Cross References Inbound
    * Utility:              SQL*Plus
    * Created by:           
    * Creation   Date:      
    *
    * Description:         This script calls all other scripts used for installing Components
    *				   for Customer Item Cross References inbound Trnsactions.      
    *
    *           
    * Tables usage:     
    *           
...
prompt Install Completed for Customer Item Cross References Inbound
