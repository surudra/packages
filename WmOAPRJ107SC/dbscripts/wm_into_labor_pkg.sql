...
CREATE OR REPLACE PACKAGE Wm_LaborTxn_Imp_Handler_Pkg AS

-- Procedure to determine calling parameters for PA Import Concurrent Request
-- Takes in the mandatory and optional parameters required for PA Concurrent Request
...
BEGIN
	  ...
	  o_errmsg:='Fetching Transaction Source';
	  ...
	  o_errmsg:='Submitting Concurrent Request';
