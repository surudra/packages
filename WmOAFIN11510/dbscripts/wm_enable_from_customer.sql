...
/
ALTER TRIGGER WM_HZ_CUSTOMER_PROFILES_IU_TRG ENABLE;
/
ALTER TRIGGER WM_HZ_CUST_ACCOUNTS_IU_TRG ENABLE;
/
ALTER TRIGGER WM_HZ_CUST_ACCT_RELATE_IU_TRG ENABLE;
/
ALTER TRIGGER WM_HZ_CUST_ACCT_SITES_IU_TRG ENABLE;
/
ALTER TRIGGER WM_HZ_CUST_PROF_AMTS_IUD_TRG ENABLE;
/
ALTER TRIGGER WM_HZ_CUST_SITE_USES_IU_TRG ENABLE;
/
ALTER TRIGGER WM_HZ_LOCATIONS_IU_TRG ENABLE;
/
ALTER TRIGGER WM_HZ_PARTIES_U_TRG ENABLE;
/
ALTER TRIGGER WM_HZ_CUST_ACCT_ROLES_I_TRG ENABLE;
/
