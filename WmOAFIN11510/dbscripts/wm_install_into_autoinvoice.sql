/*  ***************************************************************************
    ...
    * Process Name:         Installation Script for AutoInvoice Inbound
    * Program Name:         wm_install_into_autoinvoice.sql
    * Version #:            1.0
    * Title:                Installation Script for AutoInvoice Inbound
    * Utility:              SQL*Plus
    * Created by:           
    * Creation   Date:      
    *
    * Description:         This script calls all other scripts used for installing Components
    *			   for AutoInvoice inbound Trnsactions.      
    *
    *           
    * Tables usage:     
    *           
...
@@wm_into_autoinvoice_pkg.sql

SHOW ERRORS

prompt Install Completed for AutoInvoice Inbound
