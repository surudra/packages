...
/*Following fields need to be added as a result of Impact Analysis between 11.5.9 and 11.5.10*/
fvl.TRACKING_QUANTITY_IND TRACKING_QUANTITY_IND ,                        
 fvl.ONT_PRICING_QTY_SOURCE ONT_PRICING_QTY_SOURCE,                    
 
 fvl.VMI_MINIMUM_UNITS    VMI_MINIMUM_UNITS          ,                        
 fvl.VMI_MINIMUM_DAYS   VMI_MINIMUM_DAYS               ,                          
 fvl.VMI_MAXIMUM_UNITS VMI_MAXIMUM_UNITS        ,                              
 fvl.VMI_MAXIMUM_DAYS VMI_MAXIMUM_DAYS         ,                              
 fvl.VMI_FIXED_ORDER_QUANTITY VMI_FIXED_ORDER_QUANTITY,                           
 fvl.SO_AUTHORIZATION_FLAG SO_AUTHORIZATION_FLAG,                              
 fvl.CONSIGNED_FLAG  CONSIGNED_FLAG    ,                                  
 fvl.ASN_AUTOEXPIRE_FLAG ASN_AUTOEXPIRE_FLAG,                                
 fvl.VMI_FORECAST_TYPE  VMI_FORECAST_TYPE  ,                                
 fvl.FORECAST_HORIZON FORECAST_HORIZON   ,                                 
 fvl.EXCLUDE_FROM_BUDGET_FLAG EXCLUDE_FROM_BUDGET_FLAG,                           
 fvl.DAYS_TGT_INV_SUPPLY DAYS_TGT_INV_SUPPLY  ,                               
 fvl.DAYS_TGT_INV_WINDOW DAYS_TGT_INV_WINDOW  ,                               
 fvl.DAYS_MAX_INV_SUPPLY  DAYS_MAX_INV_SUPPLY ,                               
 fvl.DAYS_MAX_INV_WINDOW  DAYS_MAX_INV_WINDOW ,                              
 fvl.DRP_PLANNED_FLAG  DRP_PLANNED_FLAG   ,                                 
 fvl.CRITICAL_COMPONENT_FLAG CRITICAL_COMPONENT_FLAG ,                          
 fvl.CONTINOUS_TRANSFER CONTINOUS_TRANSFER ,                               
 fvl.CONVERGENCE CONVERGENCE,                                       
 fvl.DIVERGENCE DIVERGENCE,                                       
 fvl.CONFIG_ORGS CONFIG_ORGS ,                                       
 fvl.CONFIG_MATCH  CONFIG_MATCH      
