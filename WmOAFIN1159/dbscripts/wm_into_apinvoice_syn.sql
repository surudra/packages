/*  ***************************************************************************
    ...
    * Process Name:         Create Synonyms for AP Invoice inbound in Application Schema  
    * Program Name:         wm_into_apinvoice_syn.sql
    * Version #:            1.0
    ...
    * Description:              
    *
    *           Create Synonyms in APPS schema for AP inbound Sequences
    *     
    *
...
*/
  ...
  prompt Program : wm_into_apinvoice_syn.sql
...
create synonym wm_ap_group_s FOR &&custom_user..wm_ap_group_s
/
