/*  ***************************************************************************
    ...
    * Date       | Name                  | Remarks
    *==========================================================================
     14-NOV-02	   Sudip Kumar Chaudhuri   Created
    ***************************************************************************
*/
 ...
 ----------------------------------------------------------------------------
CREATE OR REPLACE PACKAGE Wm_Journal_Imp_Handler_Pkg AS
...
BEGIN
	...
	o_errmsg:='Error Generating run id sequence.';
	...
	o_errmsg:='Error Selecting je_source_name.';
	...
	o_errmsg:='Error Generating group id sequence.';
	...
	o_errmsg:='Error Updating group id.';
	...
	o_errmsg:='Error initializing environment inside handle journal.';
	...
	o_errmsg:='Error Getting set of book id from Applications profile.';
		
	v_set_of_books_id:=Fnd_Profile.Value('GL_SET_OF_BKS_ID');

	o_errmsg:='Error Inserting into gl_interface_control.';
	...
	o_errmsg:='Error Calling Wm_Conc_Request_Pkg package.';
