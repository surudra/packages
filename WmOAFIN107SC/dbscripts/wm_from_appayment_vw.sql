/*  ***************************************************************************
    ...
    * Process Name:	    Create Custom Views	for Ap Payment outbound	in Application Schema  
...
*/
 ...
 prompt	Program	: wm_from_appayment_vw.sql
...
SELECT 
	...
	AC.RELEASED_AT RELEASED_DATE ,
	PPF1.FULL_NAME RELEASED_BY ,
	AC.STOPPED_AT STOPPED_DATE ,
