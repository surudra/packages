/*  ***************************************************************************
    ...
    * Process Name:         Installation Script for AR Transactions Outbound
    * Program Name:         wm_install_from_artrans.sql
    * Version #:            1.0
    * Title:                Installation Script for AR Transactions Outbound
    * Utility:              SQL*Plus
    * Created by:           
    * Creation   Date:      
    *
    * Description:         This script calls all other scripts used for installing compenents 
    *				   for AR Transactions Trnsactions.      
    *
    *           
    * Tables usage:     
    *           
...
prompt Install Completed for AR Transactions Outbound
