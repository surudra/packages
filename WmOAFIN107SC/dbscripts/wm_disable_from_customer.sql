/*  ***************************************************************************
    ...
    * 
    *		
    * Triggers to disable: 	 		  WM_RA_CUSTOMERS_IU_TRG 
...
ALTER TRIGGER WM_RA_CUSTOMERS_IU_TRG DISABLE;
/
ALTER TRIGGER WM_RA_ADDRESSES_IU_TRG DISABLE;
/
ALTER TRIGGER WM_AR_CUSTOMER_PROFILES_IU_TRG DISABLE;
/
ALTER TRIGGER WM_AR_CUST_PROF_AMTS_IUD_TRG DISABLE;
/
ALTER TRIGGER WM_AP_BANK_ACCOUNT_USES_IU_TRG DISABLE;
/
ALTER TRIGGER WM_RA_SITE_USES_IU_TRG DISABLE;
/
ALTER TRIGGER WM_RA_PHONES_IUD_TRG DISABLE;
/
ALTER TRIGGER WM_RA_CUST_RELATIONS_IU_TRG DISABLE;
/
ALTER TRIGGER WM_RA_CUST_RECP_METHODS_IU_TRG DISABLE;
/
ALTER TRIGGER WM_RA_CONTACTS_IU_TRG DISABLE;
/
ALTER TRIGGER WM_RA_CONTACT_ROLES_IUD_TRG DISABLE;
/
