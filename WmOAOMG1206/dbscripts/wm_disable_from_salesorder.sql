/*  ***************************************************************************
    ...
    * Program Name:         wm_disable_from_salesorder.sql
    * Version #:            1.0
...
*/
  ...
  prompt Program : wm_disable_from_salesorder.sql
...
/
ALTER TRIGGER WM_ORDER_LINES_IUD_TRG DISABLE
/
ALTER TRIGGER WM_SALES_CREDITS_IUD_TRG DISABLE
/
ALTER TRIGGER WM_OE_LOTSERIAL_IUD_TRG DISABLE
/
ALTER TRIGGER WM_OE_PRICE_ADJ_IUD_TRG DISABLE
/
ALTER TRIGGER WM_OE_PRICE_ATTRIBS_IUD_TRG DISABLE
/
ALTER TRIGGER WM_LINE_SETS_IUD_TRG DISABLE
/
SHOW ERRORS
