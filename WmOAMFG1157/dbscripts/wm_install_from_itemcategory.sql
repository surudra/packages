/*  ***************************************************************************
    ...
    * Process Name:         Installation Script for Item Category Query
    * Program Name:         wm_install_from_itemcategory.sql
    * Version #:            1.0
    * Title:                Installation Script for Item Category Query
    * Utility:              SQL*Plus
    * Created by:           
    * Creation   Date:      
    *
    * Description:         This script calls all other scripts used for installing compenents 
    *			   for Item Category Outbound Transactions.      
    *
    *           
    * Tables usage:     
    *           
...
prompt Install Completed for Item Category Query
