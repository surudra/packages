/*  ***************************************************************************
    ...
    * Process Name:         Create Synonyms for wip work order Transaction Inbound in Application Schema  
    * Program Name:         wm_into_workorder_syn.sql
    * Version #:            1.0
...
*/
  ...
  prompt Program : wm_into_workorder_syn.sql

  --------------------------------------------- 
  -- Connect to APPS Account and create Synonym
  ---------------------------------------------
...
CREATE SYNONYM wm_wip_group_id_s FOR &&custom_user..wm_wip_group_id_s
/

DROP SYNONYM wm_wip_header_id_s
/

CREATE SYNONYM wm_wip_header_id_s FOR &&custom_user..wm_wip_header_id_s
/
