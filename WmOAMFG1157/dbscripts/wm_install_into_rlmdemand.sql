/*  ***************************************************************************
    ...
    * Process Name:         Installation Script for Demand Schedule Inbound
    * Program Name:         wm_install_into_rlmdemand.sql
    * Version #:            1.0
    * Title:                Installation Script for Demand Schedule Inbound
    * Utility:              SQL*Plus
    * Created by:           
    * Creation   Date:      
    *
    * Description:         This script calls all other scripts used for installing Components
    *				   for Demand Schedule Transaction Inbound
    *
    *           
    * Tables usage:     
    *           
...
prompt Install Completed for Demand Schedule Inbound transaction
