/*  ***************************************************************************
    ...
    * Process Name:         Installation Script for Import Order Interface Inbound Transaction
    * Program Name:         wm_install_into_order.sql
    * Version #:            1.0
    * Title:                Installation Script for Import Order Interface Inbound Transaction
    * Utility:              SQL*Plus
    * Created by:           
    * Creation   Date:      
    *
    * Description:         This script calls all other scripts used for installing Components
    *				   for Import Order Interface Inbound Transaction 
    *
    *           
    * Tables usage:     
    *           
...
@@wm_into_order_pkg.sql


SHOW ERRORS

prompt Install Completed for Import Order Interface Inbound Transaction
