/*  ***************************************************************************
    ...
    * Program Name:         wm_enable_from_supplier.sql
    * Version #:            1.0
    * Title:                Enable Triggers in APPS schema used for
    *				    Supplier outbound Transactions
    * Utility:              SQL*Plus
    * Created by:           
    * Creation   Date:      
    *
    * Description:           Enable Triggers in Apps schema used 
    *			     	     for Supplier outbound Transactions
    *
    *    
    * 
    *		
...
/
ALTER TRIGGER WM_PO_SUPP_SITES_ALL_IU_TRG ENABLE
/
ALTER TRIGGER WM_PO_SUPP_CONTACTS_IUD_TRG ENABLE
/
ALTER TRIGGER WM_AP_BK_SUP_AC_USE_ALL_IU_TRG ENABLE
/
