/*  ***************************************************************************
    ...
    * Program Name:         wm_from_product_catalog_qry_vw.sql
    * Version #:            1.0
...
*/
 ...
 PROMPT Program : wm_from_product_catalog_qry_vw.sql
...
hr_organization_units hou, --hr_org_units_no_join hou , 
hr_organization_units hout , 
mtl_parameters mp , 
hr_locations hl , 
po_vendors pv , 
po_vendors pv1 , 
...
po_lines_all pl , per_people_f ppf , hr_locations hl , hr_organization_units hou , 
hr_all_organization_units hout , mtl_parameters mp , po_line_locations_all pll , 
ap_terms at , ap_terms at1 , po_lookup_codes plc , po_lookup_codes plc1 , po_lookup_codes plc2 , 
po_document_types_all pdt , po_line_types plt , po_approved_supplier_list_v pasl , po_asl_attributes paa ,
mtl_system_items_kfv msi,
mtl_categories mc
WHERE 
...
po_asl_documents pad , po_approved_supplier_list pasl , po_asl_attributes paa , po_lines_all pl , 
per_people_f ppf , ap_terms at , po_lookup_codes plc , po_lookup_codes plc1 , po_lookup_codes plc2 , 
po_document_types_all pdt , po_line_types plt ,mtl_system_items_kfv msi,
mtl_categories mc
...
CREATE OR REPLACE VIEW wm_po_product_catalog_qry_vw(
web_transaction_id,
document_type, 
document_status,
org_id,
...
nsv.supplier_item
FROM 
wm_po_negotiated_sources_vw nsv, hr_all_organization_units hout
WHERE
...
ppv.supplier_item
FROM
wm_po_prior_purchases_vw ppv, hr_all_organization_units hout
WHERE
