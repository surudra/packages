/*  ***************************************************************************
    ...
    * Process Name:         Uninstall objects for WIP move Transaction inbound
    * Program Name:         wm_drop_into_movetrans.sql
    * Version #:            1.0
    * Title:                Uninstall objects used for WIP move Transaction Inbound Transactions    
    * Utility:              SQL*Plus
    * Created by:           
    * Creation   Date:      
    *
    * Description:          Uninstall objects used for WIP move Inbound Transaction    			
    *
    *           
    * Tables usage:     
    *           
...
*/
  ...
  prompt Program : wm_drop_into_movetrans.SQL
...
prompt UnInstall Complete FOR WIP move TRANSACTION Inbound
