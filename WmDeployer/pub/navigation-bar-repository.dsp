...
<TR>
	<TD width="20%" align="middle" id="definex" onclick="onPressDefinex()"> 
		<A ID="bundle-list" class="imagelink" target="rightFrame" href="define.dsp?projectName=%value -htmlcode projectName%&projectType=%value -htmlcode projectType%">
	...
	<TD width="20%" align="middle" id="mapx" onclick="onPressMapx()">
		<A ID="map-list" class="imagelink" target="rightFrame" href="mapset.dsp?projectName=%value -htmlcode projectName%&projectType=%value -htmlcode projectType%">
	...
	<TD width="20%" align="middle" id="deployx" onclick="onPressDeployx()">
		<A ID="deploy-list" class="imagelink" target="rightFrame" href="deploy.dsp?projectName=%value -htmlcode projectName%&projectType=%value -htmlcode projectType%">
