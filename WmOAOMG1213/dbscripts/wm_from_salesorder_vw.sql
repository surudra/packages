...
WM_RA_CUSTOMERS_VW CUST_ACCT,
HZ_PARTIES PARTY,
HR_ALL_ORGANIZATION_UNITS SHIP_FROM_ORG,
WM_RA_SITE_USES_ALL_VW SHIP_TO_ORG,
WM_RA_ADDRESSES_ALL_VW SHIP_TO_ADDR, 
WM_RA_SITE_USES_ALL_VW BILLORG, 
WM_RA_ADDRESSES_ALL_VW BILL_TO_ADDR,
WM_RA_SITE_USES_ALL_VW DELIVERORG, 
OE_CONTACTS_V DELIVERCONT,
WM_RA_ADDRESSES_ALL_VW DELIVER_TO_ADDR,
WM_RA_CUSTOMERS_VW DELIVER_TO_CUST,
WM_RA_CONTACTS_VW SOLDCONT, 
WM_RA_CONTACTS_VW SHIPCONT, 
WM_RA_CONTACTS_VW BILLCONT,  
WM_RA_CUSTOMERS_VW SHIP_TO_CUST,
WM_RA_CUSTOMERS_VW BILL_TO_CUST,
OE_LOOKUPS  OECAT,
OE_LOOKUPS  OESAL,
...
NULL OPERATION_CODE,
NULL STATUS_FLAG,
(SELECT distinct group_name FROM jtf_rs_defresgroups_vl where group_id =C.SALES_GROUP_ID),
