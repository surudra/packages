      ...
      throws AdapterException {
        ...
        try {
            ...
            // tuple, they are looked up together
                ...
                // since there is only one service template, we do not need to
                // differenitate the serviceName at this stage.
                
                //request the service signature
            ...
            // tuple, they are looked up together
                ...
                // There is only one dependency for these resource domains.
                // values[0][0] is either a function names.
                Document doc;
