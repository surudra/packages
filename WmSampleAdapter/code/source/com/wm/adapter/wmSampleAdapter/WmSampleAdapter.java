...
// add the message polling in Phase 4
import com.wm.adapter.wmSampleAdapter.notification.MessagePolling;

// add the listener notification in Phase 5
import com.wm.adapter.wmSampleAdapter.connection.WmSampleListener;
import com.wm.adapter.wmSampleAdapter.notification.AsyncListening;
...
public class WmSampleAdapter extends WmAdapter implements WmSampleAdapterConstants
{
    ...
    */
    ...
    public void fillAdapterTypeInfo (AdapterTypeInfo info, Locale locale) {
        ...
        // add at Phase 5 to support listener notification
        info.addListenerType(WmSampleListener.class.getName());

        /* add your notification templates here */
        // add at Phase 4 to support polling notification
        info.addNotificationType(MessagePolling.class.getName());
