...
public interface WmSampleAdapterConstants {
    ...
    static final String ADAPTER_VERSION = "6.5";
    ...
    */
    ...
    // added at Phase 5 to support listener notification
    static final String LISTENER_TYPE = WmSampleListener.class.getName();
    static final String LISTENER_TEMPLATE = AsyncListening.class.getName();
    ...
    static final String DOMAIN_NOTIFICATION_NAMES = "notificationNames";
}