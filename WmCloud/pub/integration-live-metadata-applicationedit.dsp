            ...
            <TD width="70%">
            	...
            	<TABLE WIDTH="100%">
            		...
            		<TR>
            			...
            			<TD class="oddrow-l">
            			 		<INPUT NAME="applicationName" id="applicationName" TYPE="TEXT" VALUE="%value encode(htmlattr) applicationName%" SIZE="50" readonly />
            			 </TD>
            		</TR>
            		<TR>
            			<TD class="evenrow" nowrap>Description</TD>
            			<TD class="evenrow-l">
            			 		<INPUT NAME="description" id="description" TYPE="TEXT" VALUE="%value encode(htmlattr) description%" SIZE="50" />
            			 </TD>
            		</TR>
            		<TR>
            			...
            			<TD class="oddrow-l" nowrap>
	           			...
	           			<TABLE width="100%">
	           				<TR>
 	           					<TD width="75%"><b>Package/Services</b></TD>
 	           					<TD width="25%"><b>Display Name</b></TD>
 	           				</TR>
 	           				<TR>
 	           					<TD width="75%">&nbsp;</TD>
 	           					<TD width="25%">&nbsp;</TD>
 	           						...
 	           						<TR title="%value name%">
 	           							<TD colspan="2">
 	           								<a onclick="toggle(this,'%value encode(javascript) name%');">
 	           									<img id="img%value name%" src="images/plus.gif"/><label class=".label"> &nbsp;%value encode(htmlall) name% </label>
