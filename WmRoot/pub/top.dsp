										...
										%else%
											...
											%invoke wm.server.query:getLicenseSettings%
												%ifvar keyExpired%
													<TD width=100% class="keymessage">
														<center>
															<A  class="keymessage" HREF="settings-license-edit.dsp" TARGET="body">
                               ...
                               %else%
									...
									%invoke wm.server.quiesce:getCurrentMode%
										 %ifvar isQuiesceMode equals('true')%
											<A  target="body" href='quiesce-report.dsp' onclick="return switchToQuiesceMode(document.htmlform_toggle_mode,'%value isQuiesceMode%');"  id="Qlink">Exit Quiesce Mode</A>
										 %else%
											<A  target="body" href='quiesce-report.dsp' onclick="return switchToQuiesceMode(document.htmlform_toggle_mode,'%value isQuiesceMode%');"  id="Qlink">Enter Quiesce Mode</A>
										 %endif%
                                    ...
                                    |
                                    <A target='body' href='top-logoff.dsp?sessionid=%value sessionid%'
