	      ...
	      <TD colspan=2>
	        <TABLE class="tableView">
                  ...
                  <TR>
                    ...
                    <TD nowrap class="oddcol">Client IP</TD>
                    <TD nowrap class="oddcol">Session State</TD>
                    <TD nowrap class="oddcol">Rpcs</TD>
                    <TD nowrap class="oddcol">Age</TD>
                    <TD nowrap class="oddcol">Session ID</TD>
                  </TR>
                  %ifvar message%
