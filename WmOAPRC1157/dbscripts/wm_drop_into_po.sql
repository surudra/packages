/*  ***************************************************************************
    ...
    * Process Name:         Uninstall objects for PO inbound
    * Program Name:         wm_drop_into_po.sql
    * Version #:            1.0
    * Title:                Uninstall objects used for PO Inbound Transactions    
    * Utility:              SQL*Plus
    * Created by:           
    * Creation   Date:      
    *
    * Description:          Uninstall objects used for PO Inbound Transactions    			
    *
    *           
    * Tables usage:     
    *           
...
*/
  ...
  prompt Program : wm_drop_into_po.sql
...
DROP PACKAGE WM_OPENPO_IMP_HANDLER_PKG
/
...
prompt UnInstall Complete for PO Inbound
