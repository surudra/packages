...
<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="/WmRoot/b2bStyle.css"></link>
        <link rel="stylesheet" type="text/css" href="/WmVCS/vcs.css"></link>
    </head>
                ...
                <table width=100%>
                    ...
                    %loop -struct%
                        %scope #$key%
                            <tr class="message">
                                <td id="message">
                                    <b><a href=/WmVCS/error/showErrorDetail.dsp?errorMessage=%value -urlencode $key%>%value message%</a></b>
                        ...
                        <td valign="top" width=50%>
                            <table class="table2" width=100%>
                                ...
                                <tr>
                                    ...
                                    <td class="oddrowdata">
                                        <a href=editLogLevel.dsp?logId=WmVCS>change</a>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="oddrowdata" colspan=2>
                                        <a href=/WmVCS/error/showErrors.dsp>view</a>
                                    </td>
                                </tr>
